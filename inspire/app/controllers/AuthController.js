...
function authButton(user) {
  ...
  return user && user.isAuthenticated
    ? /* html */ `
    <button class="btn btn-small text-muted selectable" onclick="app.AuthController.logout()" title="logout"><i class="mdi mdi-logout f-16"></i></button>
  `
    : /* html */ `
    <button class="btn btn-light rounded-pill" onclick="app.AuthController.login()">login</button>
  `
}
...
//   return account
//     ? /* html */ `
//       <a href="/#/account" class="nav-link selectable rounded" title="Manage Account">
